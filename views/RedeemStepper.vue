<template>
    <RabinStepper class="gift-card-stepper" :active-step="activeStep" :items="computedItems"/>
</template>
...
.gift-card-stepper {
  background: linear-gradient(to bottom, rgb(var(--v-theme-primary-lighten-1)) 50%, rgb(var(--v-theme-surface)) 50%);
}
</style>